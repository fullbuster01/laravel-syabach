...
<div class="animated fadeIn">
    ...
    <div class="orders">
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    @forelse ($items as $item)
                                        <tr>
                                            <td>{{ $loop->iteration + ($items->currentPage() * 5 - 5)}}</td>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td>{{ $item->email }}</td>
                                            <td>{{ $item->number }}</td>
                                    ...
                                    @empty
                                        Product belum ada yang terjual
                                    @endforelse
        ...
        <div class="row">
            <div class="d-flex justify-content-center col-xl-8">
                <div>
                    {{ $items->links() }}
                </div>
            </div>
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            let piedata = [
                ...
                { label: "Success s ", data: [[1, {{ $pie['success'] }} ]], color: '#66bb6a'}
            ];
